...
export function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Veja o histórico completo de trabalhos e avaliações de cada profissional.",
    },
    {
      icon: Users,
      title: "Suporte Completo",
      description:
        "Acompanhe seu serviço do orçamento até a conclusão com chat integrado.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left z-10 w-full">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-[4rem] font-bold text-slate-900 leading-[1.05] tracking-tight mb-6">
                ...
                de <span className="text-indigo-600">profissionais</span> do
                Brasil
              </h1>
      ...
      <section
        id="services"
        className="py-24 bg-slate-50 border-b border-border/50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-slate-500">
              Encontre profissionais qualificados e avaliados para qualquer tipo
              de projeto ou manutenção.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {services.map((service, index) => (
              <Link
                key={index}
                href={`/search?specialty=${service.name}`}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-slate-50/50 backdrop-blur-sm border border-slate-100 rounded-3xl p-8 hover:shadow-xl hover:shadow-indigo-500/5 transition-all group"
                >
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-snug">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-slate-800">
            ...
            <div className="px-4">
              <div className="text-4xl md:text-5xl font-bold mb-2 tracking-tight flex justify-center items-baseline gap-1">
      ...
      <section className="py-24 bg-gradient-to-b from-indigo-50 to-white border-t border-indigo-100/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-500 mb-10 max-w-2xl mx-auto">
            Junte-se a milhares de pessoas que já simplificaram a contratação de
