...
export function BusinessDashboard() {
  ...
  const totalActiveServices = providers.reduce(
    (sum, p) => sum + p.activeServices,
    0,
  );
  const averageRating = (
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <div
                className={`w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg ${isExpert ? "bg-gradient-to-br from-pink-600 to-pink-500 shadow-pink-100" : "bg-gray-400 shadow-gray-100"}`}
              >
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-full border shadow-sm ${isExpert ? "bg-pink-50 text-pink-700 border-pink-100" : "bg-gray-100 text-gray-700 border-gray-200"}`}
                  >
                    <Star
                      className={`w-3 h-3 ${isExpert ? "fill-pink-600 text-pink-600" : "fill-gray-400 text-gray-400"}`}
                    />
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-gray-600 font-medium tracking-tight whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px]">
                    Empresa Demo Ltda.
                  </p>
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 bg-white border border-gray-200 text-gray-700 px-4 py-2.5 rounded-lg font-semibold hover:bg-gray-50 transition-all shadow-sm">
