...
export function OrganizeProfile() {
  ...
  const [portfolioItems, setPortfolioItems] = useState<PortfolioItem[]>([
    {
      ...
      description:
        "Instalação completa de sistema elétrico em apartamento de 80m²",
    ...
    },
    {
      ...
      category: "Eletricista",
      images: [
        "https://images.unsplash.com/photo-1751486289947-4f5f5961b3aa?w=400",
      ],
      order: 2,
    },
  ]);
  ...
  const [highlights, setHighlights] = useState([
    ...
    {
      id: "3",
      text: "Garantia de 6 meses em todos os serviços",
      enabled: true,
    },
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
            ...
            <p className="text-gray-600 mb-8">
              A opção Organizar Perfil está disponível apenas para prestadores
              com plano premium.
            </p>
            <Link
              to="/dashboard"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Adicione quantos trabalhos quiser
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Crie badges únicos para seu perfil
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Organize seus trabalhos anteriores para impressionar
                    clientes
                  </p>
                </div>
                <Link
              ...
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-900">
                  <strong>Dica:</strong> Arraste os itens para reorganizar a
                  ordem de exibição. Os trabalhos mais impressionantes devem
                  aparecer primeiro!
                </p>
              </div>
            </div>
                ...
                {highlights.map((highlight) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Star
                        className={`w-5 h-5 ${highlight.enabled ? "text-amber-500 fill-amber-500" : "text-gray-400"}`}
                      />
                      <span
                        className={`font-medium ${highlight.enabled ? "text-gray-900" : "text-gray-600"}`}
                      >
                        {highlight.text}
                      </span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() => {
                          const enabledCount = highlights.filter(
                            (h) => h.enabled,
                          ).length;
              ...
              <div className="space-y-3">
                {featuredServices.map((service) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Award
                        className={`w-5 h-5 ${service.featured ? "text-blue-600" : "text-gray-400"}`}
                      />
                      <span
                        className={`font-medium ${service.featured ? "text-gray-900" : "text-gray-600"}`}
                      >
                        {service.name}
                      </span>
                      {service.featured && (
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() => {
                          const featuredCount = featuredServices.filter(
                            (s) => s.featured,
                          ).length;
